      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch min-h-[82vh]">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 text-sm sm:text-base max-w-lg leading-relaxed pt-2 font-sans-body">
                Award-winning London luxury hair & beauty sanctuary. Handcrafted precision cuts, couture balayage, and restorative treatments tailored to your unique elegance.
              </p>
            </div>
            ...
            <div className="pt-8 sm:pt-12 space-y-8">
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t border-zinc-200 dark:border-zinc-800">
                <div>
                  <div className="font-display text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white">15+</div>
                  <div className="text-[11px] uppercase tracking-wider text-zinc-500 font-medium mt-0.5">Years Legacy</div>
                </div>
                <div>
                  <div className="font-display text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white">4.9★</div>
                  <div className="text-[11px] uppercase tracking-wider text-zinc-500 font-medium mt-0.5">Client Rating</div>
                </div>
                <div>
                  <div className="font-display text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white">20k+</div>
                  <div className="text-[11px] uppercase tracking-wider text-zinc-500 font-medium mt-0.5">Clients Styled</div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            {/* Overlaid Bottom Typography matching screenshot: "YOUR HAIRS BEST FRIEND" */}
